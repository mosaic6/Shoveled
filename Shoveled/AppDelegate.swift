...
//        Stripe.setDefaultPublishableKey("pk_live_xvZp8nbvhuCB3pIrykXwZOEn")
        ...
        if application.respondsToSelector("didRegisterForRemoteNotificationsWithDeviceToken:") {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Shoveled", withExtension: "momd")!
