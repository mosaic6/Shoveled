# -*- encoding: utf-8 -*-
# stub: cocoapods 1.1.0.beta.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cocoapods-core>, ["= 1.1.0.beta.1"])
      s.add_runtime_dependency(%q<claide>, ["< 2.0", ">= 1.0.0"])
      s.add_runtime_dependency(%q<cocoapods-deintegrate>, ["< 2.0", ">= 1.0.0"])
      s.add_runtime_dependency(%q<cocoapods-downloader>, ["< 2.0", ">= 1.1.0"])
      ...
      s.add_runtime_dependency(%q<molinillo>, ["~> 0.5.0"])
      s.add_runtime_dependency(%q<xcodeproj>, ["< 2.0", ">= 1.2.0"])
      s.add_runtime_dependency(%q<activesupport>, ["< 5", ">= 4.0.2"])
      s.add_runtime_dependency(%q<colored>, ["~> 1.2"])
      s.add_runtime_dependency(%q<escape>, ["~> 0.0.4"])
      s.add_runtime_dependency(%q<fourflusher>, ["~> 1.0.1"])
      ...
      s.add_dependency(%q<cocoapods-core>, ["= 1.1.0.beta.1"])
      s.add_dependency(%q<claide>, ["< 2.0", ">= 1.0.0"])
      s.add_dependency(%q<cocoapods-deintegrate>, ["< 2.0", ">= 1.0.0"])
      s.add_dependency(%q<cocoapods-downloader>, ["< 2.0", ">= 1.1.0"])
      ...
      s.add_dependency(%q<molinillo>, ["~> 0.5.0"])
      s.add_dependency(%q<xcodeproj>, ["< 2.0", ">= 1.2.0"])
      s.add_dependency(%q<activesupport>, ["< 5", ">= 4.0.2"])
      s.add_dependency(%q<colored>, ["~> 1.2"])
      s.add_dependency(%q<escape>, ["~> 0.0.4"])
      s.add_dependency(%q<fourflusher>, ["~> 1.0.1"])
